    ...
    return (
      <Fragment>
        {type == "add" ? (
          ...
          <a
            style={{ color: "#006acc", margin: "0 10px" }}
...
export default class App extends React.Component {
  ...
  componentDidMount() {
    request(
      `http://114.67.90.231:8888/select_supplier?id=${this.props.id}`
    ).then(payload => this.setState({ supply: payload.pageData }));
  }
